...
@section('content')
    <div class="no-print flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('admin.reports.aged-receivables') }}" class="text-xs text-slate-300 hover:text-white px-3 py-2">Refresh</a>
        </div>
    </div>

    <x-documents.school-header 
        :school="$school ?? null"
        title="Official Aged Receivables & Aging Buckets Report"
        :subtitle="'As of: ' . $asOf . ' · Grand Total Overdue: $' . number_format($grandTotal, 2)"
        :date="now()"
    />
    ...
    <x-documents.school-footer 
        :school="$school ?? null"
        :show-banking="false"
        notice="Official aged receivables statement. Generated from student billing accounts ledger."
    />
@endsection
