...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Log the creation
        AuditService::log($school->id, auth()->id(), 'create', 'employee', $employee->id, 
            "Employee created: {$employee->first_name} {$employee->last_name}", request()->ip(), request()->userAgent(), 'hr-management');
