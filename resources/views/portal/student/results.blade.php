...
@section('content')
    <div class="flex items-center justify-between mb-4">
        <div>
            <h1 class="text-lg font-semibold text-slate-50">My Results</h1>
            <p class="text-xs text-slate-400 mt-1">View your academic performance and grades.</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-xs">
                ...
                <tbody class="divide-y divide-slate-800">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-4 py-8 text-center text-slate-500">No results found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
